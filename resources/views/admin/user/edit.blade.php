                    ...
                    <form method="post" action="/admin/user/{{$user->id}}" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <img style="height: 200px; cursor: pointer;" class="thumbnail rounded-circle" data-toggle="tooltip" title="Click to change the image" data-placement="bottom" src="front/img/user/{{$user->avatar}}" alt="Avatar">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="phone" id="phone" placeholdefr="Phone" type="tel" class="form-control" value="{{$user->phone}}">
                            </div>
                        </div>

                        ...
                        <div class="col-lg-7 col-md-7">
                            <form action="">
                                <div class="select-option">
                                    <select class="sorting" onchange="this.form.submit();" name="sort_by" id="">
                                        ...
                                        <option {{ request('sort_by') == 'name-descebding' ? 'selected' : '' }} value="name-descebding">Sorting: Name Z-A</option>
                                        <option {{ request('sort_by') == 'price-ascending' ? 'selected' : '' }} value="price-ascending">Sorting: Price Ascending</option>
                                        <option {{ request('sort_by') == 'price-descebding' ? 'selected' : '' }} value="price-descebding">Sorting: Price Decrease</option>
                                    </select>
                                    <select class="p-show" onchange="this.form.submit();" name="show" id="">

                    ...
                    <!-- <div class="lan-selector">
                        <select style="width: 300px" name="countries" id="countries" class="language_drop">
                            <option value="yt" data-image="front/img/flag-1.jpg" data-imagecss="flag yt" data-title="English">
                                English</option>
                            <option value="yu" data-image="front/img/flag-2.jpg" data-imagecss="flag yu" data-title="Bangladesh">Germany</option>
                        </select>
                    </div> -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            ...
                            </script>All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://Codelearn.vn" target="_blank">CodeLearn</a>

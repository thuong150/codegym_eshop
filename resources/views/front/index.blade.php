            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
                        <h1>Black friday</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad vel doloribus magni nulla eos
                            facere voluptas error in, pariatur quibusdam quidem ipsa minus magnam recusandae
                            cupiditate maiores, et hic odit?</p>
    ...
    <div class="container">
        <div class="col-lg-6 text-center">
            <div class="section-title">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates nobis qui vitae illo omnis
                    natus consequuntur laborum!</p>
...
<section class="instagram-photo">
    <div class="insta-item set-bg" data-setbg="front/img/insta-1.jpg">
        <div class="inside-text">
            ...
            <h5><a href="#">CodeLearn_Collection</a></h5>
        </div>
    </div>

                        ...
                        <div class="order-total">
                            <ul class="order-table">
                                ...
                                <li class="total-price">
                                    Total 
                                    <span>${{ array_sum(array_column($order->orderDetails->toArray(), 'total')) }}</span></li>
                            </ul>
                            <div class="payment-check">
                                ...
                                <div class="pc-item">
                                    <label for="pc-paypal">
                                        Online payment
                                        <input disabled checked type="radio" name="payment_type" value="online_payment" id="pc-paypal" {{$order->payment_type == 'online_payment' ? 'checked' : ''}}>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                            </div>
